...
| **REAL-DATA-07** — replication and the illumination envelope on 42 real pairs | **COMPLETE — S4, S2 MET; S1, S3, S5, S6 NOT MET.** Pooled separation p = 0.0042, 0 wrong passes in 37, nothing succeeds above 40°; **replication NOT MET** (E2 fails vs A and vs B); four frames fail against every partner irrespective of Δincidence (D-049); B4L widens nothing at native scale (D-047-N1) |
